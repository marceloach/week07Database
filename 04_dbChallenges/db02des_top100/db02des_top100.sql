...
-- Started on 2022-06-29 18:24:10
...
CREATE TABLE public.peliculas (
    ...
    periodo_estreno integer,
    director character varying(45)
);
...
ALTER TABLE public.peliculas ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- TOC entry 3311 (class 0 OID 24721)
-- Dependencies: 210
-- Data for Name: peliculas; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.peliculas (id, pelicula, periodo_estreno, director) FROM stdin;
...
5	El SeÃ±or de los anillos: El retorno del rey	2003	Peter Jackson
6	El caballero oscuro	2008	Christopher Nolan
7	Cadena perpetua	1994	Frank Darabont
8	Piratas del Caribe: La maldiciÃ³n de la Perla Negra	2003	Gore Verbinski
...
18	El SeÃ±or de los anillos: Las dos torres	2002	Peter Jackson
19	Harry Potter y el Prisionero de Azkaban	2004	Alfonso CuarÃ³n
...
29	Parque JurÃ¡sico	1993	Steven Spielberg
...
52	Lo que el viento se llevÃ³	1939	Victor Fleming
53	El Laberinto del Fauno	2006	Guillermo del Toro
54	Los increÃ­bles	2004	Brad Bird
...
59	Indiana Jones y la Ãºltima cruzada	1989	Steven Spielberg
...
74	TiburÃ³n	1975	Steven Spielberg
...
81	Alguien volÃ³ sobre el nido del cuco	1975	Milos Forman
...
93	Sweeney Todd: El barbero diabÃ³lico de la calle Fleet	2007	Tim Burton
...
--
-- TOC entry 3312 (class 0 OID 24726)
-- Dependencies: 211
-- Data for Name: reparto; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.reparto (pelicula_id, actor) FROM stdin;
1	Tom Hanks
1	Robin Wright Penn
1	Gary Sinise
...
--
-- TOC entry 3169 (class 2606 OID 24725)
...
--
-- TOC entry 3170 (class 2606 OID 24729)
-- Name: reparto reparto_pelicula_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reparto
    ADD CONSTRAINT reparto_pelicula_id_fkey FOREIGN KEY (pelicula_id) REFERENCES public.peliculas(id);


-- Completed on 2022-06-29 18:24:11
